...
def classifica_image(image_path, model, class_names):
...
def handle_image(image_path):
    ...
    for i, detection in enumerate(detections):
        try:
            if detection.get('name') == 'sports ball':
                ...
                if box_points:
                    ...
                    class_name, confidence = classifica_image(object_path, model, class_names)
